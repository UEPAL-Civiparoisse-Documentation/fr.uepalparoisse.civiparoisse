...
return [
  [
    'name' => 'SavedSearch_Civip_Foyers_avec_Evenement',
    'entity' => 'SavedSearch',
    'cleanup' => 'always',
    'update' => 'always',
    'params' => [
      'version' => 4,
      'values' => [
        'name' => 'Civip_Foyers_avec_Evenement',
        'label' => 'Foyers avec Evénement',
        'form_values' => null,
        'mapping_id' => null,
        ...
        'expires_date' => null,
        'description' => "Recherche des Foyers ayant participé à un Evénement",
      ],
      'match' => [
        'name',
      ],
  ...
  [
    'name' => 'SavedSearch_Civip_Foyers_avec_Evenement_SearchDisplay_Civip_Foyers_avec_Evenement_Table',
    ...
    'params' => [
      'version' => 4,
      'values' => [
        'name' => 'Civip_Foyers_avec_Evenement_Table',
        'label' => 'Foyers avec Evénement Table',
        'saved_search_id.name' => 'Civip_Foyers_avec_Evenement',
        'type' => 'table',
        'settings' => [
          'description' => null,
          'sort' => [
