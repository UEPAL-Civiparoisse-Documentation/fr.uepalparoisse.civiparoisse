...
<div class="crm-section">
  <crm-angular-js modules="hvaddrdialog">
    <div class="addrvirtualcontainer">
      <button name="show_hvaddr" type="button" hvaddr-dialog-popup="hvaddrdialog">Assitant</button>
    </div>
  </crm-angular-js>
</div>
	...
	<div class="crm-section">
		<div class="label">{$form.mode_distribution.label}</div>
		<div class="content">{$form.mode_distribution.html}</div>
		<div class="clear"></div>
	</div>
