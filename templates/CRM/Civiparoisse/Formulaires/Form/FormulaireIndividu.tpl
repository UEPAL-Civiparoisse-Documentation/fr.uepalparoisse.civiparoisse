...
<h2>Saisie des informations sur l'Individu</h3>
	<h3>Nom du Foyer ou de l'Organisation de rattachement</h3>
	<div class="form-pretexte">Tout individu doit être rattaché à un Foyer ou à une Entreprise ou à une Organisation</div>
	<div class="crm-section">
		<div class="label">{$form.entity_link.label}</div>
		<div class="content">{$form.entity_link.html}</div>
		<div class="clear"></div>
	</div>
