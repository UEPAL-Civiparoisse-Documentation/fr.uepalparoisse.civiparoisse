<div class="crm-block crm-form-block crm-contact-task-mailing-label-form-block">
  ...
  <table class="form-layout-compressed">
    ...
    <tr class="crm-contact-task-mailing-label-form-block-transpose">
      <td class="label">{$form.transpose.label}</td>
      <td>{$form.transpose.html}</td>
    </tr>
    <tr class="crm-contact-task-mailing-label-form-block-offset">
      <td class="label">{$form.offset.label}</td>
      <td>{$form.offset.html}</td>
    </tr>
