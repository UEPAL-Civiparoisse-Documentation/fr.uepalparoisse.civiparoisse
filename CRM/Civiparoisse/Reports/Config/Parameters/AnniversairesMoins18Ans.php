...
class CRM_Civiparoisse_Reports_Config_Parameters_AnniversairesMoins18Ans extends CRM_Civiparoisse_SavedSearch_BaseParameter {

	const NAME = 'Civip_Anniversaires_Moins_18_ans';
  ...
  /**
   * Create la recherche Anniversaires des Jeunes de moins de 18 ans 
  ...
  public function getParametersSearch(string $name): array {
		...
		return [
			'values' => [
				'name'=> $name,
				'label' => 'Anniversaires Moins de 18 ans',
				'form_values' => null,
				'mapping_id' => null,
				'search_custom_id' => null,
				'description' => 'Anniversaires des Jeunes de moins de 18 ans',
				'api_entity' => 'Contact',
				'api_params'=> [
					'version' => 4,
		      'select' => [
 ...
 /**
   * Create le Display Anniversaires des Jeunes de moins de 18 ans sous forme de Table
   * @param 	string	$name 		Name of the search
   ...
   */
	public function getParametersDisplay(string $nameDisplay, int $searchId): array {
		...
		return [
			'values' => [
				'name'=> $nameDisplay,
	    	'label' => 'Anniversaires des Jeunes de moins de 18 ans',
