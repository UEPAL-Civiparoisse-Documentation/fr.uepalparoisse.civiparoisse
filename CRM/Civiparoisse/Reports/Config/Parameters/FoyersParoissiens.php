		...
		return [
			'values' => [
		      ...
		      'select' => [
		        ...
		        'Contact_RelationshipCache_Contact_01_Contact_Membership_contact_id_01.membership_type_id:label',
		      ...
		      'join' => [
		        ...
		        [
		          'Phone AS Contact_RelationshipCache_Contact_01_Contact_Phone_contact_id_01',
		          'LEFT',
		          [
		            'Contact_RelationshipCache_Contact_01.id',
		            '=',
		        ...
		        [
		          ...
		          [
		            'Contact_RelationshipCache_Contact_01_Contact_Membership_contact_id_01.membership_type_id:name',
		            'IN',
		            [
		              'Electeur·trice',
		              'Inscrit·e Enfant'
		...
		return [
	    	...
	    	'settings'=> [
		      ...
		      'columns' => [
		        ...
		        [
		          'type' => 'field',
		          'key' => 'Contact_RelationshipCache_Contact_01_Contact_Membership_contact_id_01.membership_type_id:label',
		          'dataType' => 'Integer',
