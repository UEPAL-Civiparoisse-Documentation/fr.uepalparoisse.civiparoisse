...
/**
 * Recherche des Individus de plus de 18 ans ayant encore le Statut "Inscrit Enfant", ainsi que des Individus dont la date de création de la fiche est supérieure à 18 ans et qui ont toujours le Statut "Inscrit Enfant"
 * 
 * @return array Résultat de la requête
 */
...
/**
 * Recherche des Individus ayant plus de 27 ans (ou fiche crée il y a plus de 27 ans) et qui sont encore rattaché au Foyer de leurs parents
 * 
 * @return array Résultat de la requête
 */
