...
class CRM_Civiparoisse_Qualitebase_Config_Parameters_IndividusSansGenre
    extends CRM_Civiparoisse_SavedSearch_BaseParameter
{
    ...
    /**
     * Create la recherche Individus sans Genre
    ...
    /**
     * Create le Display Individus sans Genre sous forme de Table
     * @param string $name Name of the search
    ...
    public function getParametersDisplay(string $nameDisplay, int $searchId): array
    {
        ...
        return [
            'values' => [
                'name' => $nameDisplay,
                'label' => 'Individus Sans Genre Table',
