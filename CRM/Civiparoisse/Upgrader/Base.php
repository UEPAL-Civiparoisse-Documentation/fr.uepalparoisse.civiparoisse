 ...
 */
class CRM_Civiparoisse_Upgrader_Base {

  /**
   * @var CRM_Civiparoisse_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Civiparoisse_Upgrader(
        'fr.uepalparoisse.civiparoisse',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Civiparoisse_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Civiparoisse_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
