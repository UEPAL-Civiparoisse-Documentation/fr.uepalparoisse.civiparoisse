 ...
 */
class CRM_Civiparoisse_Customsearches_Form_Search_HouseholdwithoutMail extends CRM_Contact_Form_Search_Custom_Base implements CRM_Contact_Form_Search_Interface {
...
// Affichage des groupes à choisir
  ...
  // Relationship_type_Id = Head of Household (Chef de famille)
 ...
 */
  ...
  function where($includeContactIDs = FALSE) {
    ...
    $where = "
		...
		AND m_h.status_id IN  ('1', '2', '3')
		";

    // Relationship_type_Id = Head of Household (Chef de famille)
    // Membership_type_id = Electeur.trice, Inscrit.e Enfant, Ami.e de la paroisse
    // Status_Id = Nouveau, Courant, Délai de grâce
