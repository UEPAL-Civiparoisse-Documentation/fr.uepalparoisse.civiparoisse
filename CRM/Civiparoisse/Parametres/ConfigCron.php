...
// liste des jobs à désactiver (par sécurité)
        ...
        CU::getCronChange(
            ...
            'job',
            0,
            'Process Pledges'); // A activer lorsqu'on aura paramétré des rapports à envoyer
        ...
        // A activer éventuellement si on installe l'extension relationship-permissions-acls
        /* CU::getCronChange avec paramètres :
        'prune_temp_tables',
        'Daily',
        '',
        'Relationship',
         1,
         'Drop temporary relationship ACL tables'*/
...
// liste des jobs à créer
        CU::getCronCreate(
            ...
            'job',
            1,
            'Update Greetings and Addressees - Mail - Household'); // Update Greetings and Addressees
        CU::getCronCreate(
            'update_greeting',
            'Daily',
            "ct=Organization\ngt=email_greeting\nforce=0",
            'job',
            1,
            'Update Greetings and Addressees - Mail - Organisation'); // Update Greetings and Addressees
