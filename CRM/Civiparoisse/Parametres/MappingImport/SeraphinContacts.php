    ...
    protected function getParametersDisplay(): array
    {
        ...
        return [
            ...
            $this->computeRelationshipDisplayField('household_name',
                2,
                static::findRelationshipTypeId('Household Member of'),
                'a_b'),
            ...
            $this->computeRelationshipDisplayField(
                'organization_name',
                7,
                static::findRelationshipTypeId('Employee of'),
                'a_b'),
            ...
            $this->computeCommonDisplayField(static::findCustomFieldId('nom_naissance', self::CG_ETAT_CIVIL), 11),
            $this->computeCommonDisplayField(static::findCustomFieldId('lieu_naissance', self::CG_ETAT_CIVIL), 12),
            $this->computeCommonDisplayField('birth_date', 13),
            $this->computeCommonDisplayField('gender_id', 14),
            $this->computeCommonDisplayField(static::findCustomFieldId('date_mariage', self::CG_ETAT_CIVIL), 15),
            $this->computeCommonDisplayField(static::findCustomFieldId(
                'date_benediction_nuptiale',
                self::CG_ETAT_CIVIL),
                16),
            $this->computeCommonDisplayField(static::findCustomFieldId('paroisse_mariage', self::CG_ETAT_CIVIL), 17),
            $this->computeCommonDisplayField(static::findCustomFieldId('verset_mariage', self::CG_ETAT_CIVIL), 18),
            $this->computeCommonDisplayField(static::findCustomFieldId('divorce', self::CG_ETAT_CIVIL), 19),
            $this->computeCommonDisplayField(static::findCustomFieldId('date_divorce', self::CG_ETAT_CIVIL), 20),
            $this->computeCommonDisplayField(static::findCustomFieldId('date_veuvage', self::CG_ETAT_CIVIL), 21),
            $this->computeCommonDisplayField(static::findCustomFieldId('date_obseques', self::CG_ETAT_CIVIL), 22),
            $this->computeCommonDisplayField(static::findCustomFieldId('paroisse_enterrement', self::CG_ETAT_CIVIL), 23),
            $this->computeCommonDisplayField('is_deceased', 24),
            $this->computeCommonDisplayField(static::findCustomFieldId('securite_sociale', self::CG_ETAT_CIVIL), 25),
            $this->computeCommonDisplayField(static::findCustomFieldId('fonctionnaire', self::CG_ETAT_CIVIL), 26),
            $this->computeCommonDisplayField(static::findCustomFieldId('religion', self::CG_INFO_RELIGION), 27),
            $this->computeCommonDisplayField(static::findCustomFieldId('date_bapteme', self::CG_INFO_RELIGION), 28),
            $this->computeCommonDisplayField(static::findCustomFieldId('paroisse_bapteme', self::CG_INFO_RELIGION), 29),
            $this->computeCommonDisplayField(static::findCustomFieldId('verset_bapteme', self::CG_INFO_RELIGION), 30),
            $this->computeCommonDisplayField(static::findCustomFieldId('date_confirmation', self::CG_INFO_RELIGION), 31),
            $this->computeCommonDisplayField(static::findCustomFieldId(
            ...
            $this->computeRelationshipDisplayField(
                'household_name',
                43, static::findRelationshipTypeId('Head of Household for'),
                'a_b')
