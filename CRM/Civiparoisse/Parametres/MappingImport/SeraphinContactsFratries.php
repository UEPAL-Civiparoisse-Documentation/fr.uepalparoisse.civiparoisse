...
class CRM_Civiparoisse_Parametres_MappingImport_SeraphinContactsFratries extends CRM_Civiparoisse_Parametres_ConfigMappingImport{
  ...
  protected function getParametersDisplay() : array {
    ...
    return [
      ...
      [
        ...
        'im_provider_id' => NULL, 
        'website_type_id' => NULL, 
        'relationship_type_id' => self::findRelationshipTypeId('Sibling of'), 
