...
//Ce code est nécessaire pour la création effective
   ...
   * @param $old_value bool
   * @param $new_value bool
   * @param $metadata array
   */
  public static function onReligionFieldsetSettingChange($old_value, $new_value, $metadata)
  {
    $new_active_value = $new_value ? 1 : 0;
    $results = civicrm_api4('CustomGroup', 'update', [
      'values' => [
        'is_active' => $new_value ? TRUE : FALSE,
      ],
      'where' => [
        ['name', '=', 'informations_religion'],
      ],
